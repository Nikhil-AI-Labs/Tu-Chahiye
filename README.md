...
│   ├── fig/                21 computed figures, generated by tools/make-figures.py
...
**Computed** — `assets/fig/`, 21 files, made by `tools/make-figures.py`. These are
...
## 11. One honest paragraph about the predicted papers
